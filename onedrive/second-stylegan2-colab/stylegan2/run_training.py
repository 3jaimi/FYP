...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, image_snapshot_ticks, network_snapshot_ticks, resume_pkl, minibatch_size):
...
def main():
    ...
    parser.add_argument('--minibatch-size', help='Minibatch size (default: %(default)s)', default=32, type=int, metavar='N')
