...
def D_stylegan2(
    ...
    resample_kernel     = [1,3,3,1],    # Low-pass filter to apply when resampling activations. None = no filtering.
    **_kwargs):                         # Ignore unrecognized keyword args.
# Load EfficientNetB7 model with ImageNet weights and modified input shape
    efficientnet_model = EfficientNetB7(include_top=False, weights='imagenet', input_shape=(resolution, resolution, num_channels))
